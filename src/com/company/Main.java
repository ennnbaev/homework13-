...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(springTime.toMinutes() + " минут длилась весна в 1965 году");
        ...
        System.out.println(summerTime.toMinutes() + " минут длилось лето в 1965 году");
        ...
        System.out.println(autumnTime.toMinutes() + " минут длилась осень в 1965 году");
        ...
        System.out.println(winterTime.toMinutes()+DecemberTime.toMinutes()+"  минут длилась зима в 1965 году");
    }
}
